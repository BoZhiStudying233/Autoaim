...
path = './src/Algorithm/configure/Detector/Fitting/speed_state/'
...
with open(max_file_path , "r") as speed_txt:
    for line in speed_txt.readlines():
        ...
        now_speed.append(floatLine[2])
        now_angle.append(floatLine[3])


plt.scatter(predict_time, predict_angle, s=5, c='purple') # 紫色表示预测
plt.scatter(now_angle, now_speed, s=5, c='green') # 绿色表示真实
plt.show()