...
#include "rmos_utils/rune_armor.hpp"
#include "../../../rmos_utils/AIOF-IP/include/Common.hpp"
#include "../../../rmos_utils/AIOF-IP/include/Runtime.hpp"
...
namespace RuneDetector
{
    ...
    protected:
        ...
        int lost_num = 20;  // 丢失目标帧数阈值，超过则目标丢失LOST
