...
#ifndef RMOS_UTIL__LIFECYCLE_SERVICE_CLIENT_HPP_
#define RMOS_UTIL__LIFECYCLE_SERVICE_CLIENT_HPP_
...
#include "rmos_utils/service_client.hpp"
#include "rmos_utils/node_utils.hpp"
...
public:
  ...
  /// Get the current state as a lifecycle_msgs::msg::State
  /**
   * Throws std::runtime_error on failure
   */
  lifecycle_msgs::msg::State
  get_state(const std::chrono::seconds timeout = std::chrono::seconds(2));
