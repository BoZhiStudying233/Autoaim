...
#include <stddef.h>
#include "rmos_interfaces/msg/detail/color__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  rmos_interfaces__msg__Color__init(message_memory);
}

void Color__rosidl_typesupport_introspection_c__Color_fini_function(void * message_memory)
{
  rmos_interfaces__msg__Color__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Color__rosidl_typesupport_introspection_c__Color_message_member_array[1] = {
  {
    "color",  // name
    ...
    offsetof(rmos_interfaces__msg__Color, color),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Color__rosidl_typesupport_introspection_c__Color_message_members = {
  ...
  "Color",  // message name
  1,  // number of fields
  sizeof(rmos_interfaces__msg__Color),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmos_interfaces, msg, Color)() {
