  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  rmos_interfaces__msg__Armor__init(message_memory);
}

void Armor__rosidl_typesupport_introspection_c__Armor_fini_function(void * message_memory)
{
  rmos_interfaces__msg__Armor__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Armor__rosidl_typesupport_introspection_c__Armor_message_member_array[4] = {
  {
    "num_id",  // name
    ...
    offsetof(rmos_interfaces__msg__Armor, num_id),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rmos_interfaces__msg__Armor, pose),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rmos_interfaces__msg__Armor, distance_to_image_center),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rmos_interfaces__msg__Armor, distance),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Armor__rosidl_typesupport_introspection_c__Armor_message_members = {
  ...
  "Armor",  // message name
  4,  // number of fields
  sizeof(rmos_interfaces__msg__Armor),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmos_interfaces, msg, Armor)() {
  Armor__rosidl_typesupport_introspection_c__Armor_message_member_array[1].members_ =
