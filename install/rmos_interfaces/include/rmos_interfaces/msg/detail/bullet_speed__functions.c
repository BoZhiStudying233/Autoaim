...
rmos_interfaces__msg__BulletSpeed__create()
{
  ...
  rmos_interfaces__msg__BulletSpeed * msg = (rmos_interfaces__msg__BulletSpeed *)allocator.allocate(sizeof(rmos_interfaces__msg__BulletSpeed), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rmos_interfaces__msg__BulletSpeed));
  bool success = rmos_interfaces__msg__BulletSpeed__init(msg);
  if (!success) {
...
rmos_interfaces__msg__BulletSpeed__destroy(rmos_interfaces__msg__BulletSpeed * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    rmos_interfaces__msg__BulletSpeed__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
rmos_interfaces__msg__BulletSpeed__Sequence__init(rmos_interfaces__msg__BulletSpeed__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rmos_interfaces__msg__BulletSpeed * data = NULL;

  if (size) {
    data = (rmos_interfaces__msg__BulletSpeed *)allocator.zero_allocate(size, sizeof(rmos_interfaces__msg__BulletSpeed), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rmos_interfaces__msg__BulletSpeed__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rmos_interfaces__msg__BulletSpeed__fini(&data[i - 1]);
      }
...
rmos_interfaces__msg__BulletSpeed__Sequence__fini(rmos_interfaces__msg__BulletSpeed__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rmos_interfaces__msg__BulletSpeed__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rmos_interfaces__msg__BulletSpeed__Sequence * array = (rmos_interfaces__msg__BulletSpeed__Sequence *)allocator.allocate(sizeof(rmos_interfaces__msg__BulletSpeed__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rmos_interfaces__msg__BulletSpeed__Sequence__init(array, size);
  if (!success) {
...
rmos_interfaces__msg__BulletSpeed__Sequence__destroy(rmos_interfaces__msg__BulletSpeed__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rmos_interfaces__msg__BulletSpeed__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rmos_interfaces__msg__BulletSpeed__Sequence__are_equal(const rmos_interfaces__msg__BulletSpeed__Sequence * lhs, const rmos_interfaces__msg__BulletSpeed__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rmos_interfaces__msg__BulletSpeed__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rmos_interfaces__msg__BulletSpeed__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rmos_interfaces__msg__BulletSpeed);
    rmos_interfaces__msg__BulletSpeed * data =
      (rmos_interfaces__msg__BulletSpeed *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rmos_interfaces__msg__BulletSpeed__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          rmos_interfaces__msg__BulletSpeed__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rmos_interfaces__msg__BulletSpeed__copy(
