...
{
  new (message_memory) rmos_interfaces::msg::Color(_init);
}

void Color_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rmos_interfaces::msg::Color *>(message_memory);
  typed_message->~Color();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Color_message_member_array[1] = {
  {
    "color",  // name
    ...
    offsetof(rmos_interfaces::msg::Color, color),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Color_message_members = {
  ...
  "Color",  // message name
  1,  // number of fields
  sizeof(rmos_interfaces::msg::Color),
...
get_message_type_support_handle<rmos_interfaces::msg::Color>()
{
  return &::rmos_interfaces::msg::rosidl_typesupport_introspection_cpp::Color_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rmos_interfaces, msg, Color)() {
  return &::rmos_interfaces::msg::rosidl_typesupport_introspection_cpp::Color_message_type_support_handle;
}
