...
bool rmos_interfaces__msg__color__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmos_interfaces.msg._color.Color", full_classname_dest, 32) == 0);
  }
  rmos_interfaces__msg__Color * ros_message = _ros_message;
  {  // color
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * rmos_interfaces__msg__color__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Color */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmos_interfaces.msg._color");
  ...
  rmos_interfaces__msg__Color * ros_message = (rmos_interfaces__msg__Color *)raw_ros_message;
  {  // color
    PyObject * field = NULL;
