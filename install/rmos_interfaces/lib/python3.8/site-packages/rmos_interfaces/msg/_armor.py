...
class Armor(metaclass=Metaclass_Armor):
    ...
    def __init__(self, **kwargs):
        ...
        self.num_id = kwargs.get('num_id', int())
        from geometry_msgs.msg import Pose
    ...
    @property
    def num_id(self):
        """Message field 'num_id'."""
        return self._num_id

    @num_id.setter
    def num_id(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'num_id' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'num_id' field must be an unsigned integer in [0, 255]"
        self._num_id = value
